...
// Wait for the app, not for five seconds: after a restamp every module is
// fetched afresh and the first run after it took longer than that, the start
// button was not there to click, and the camera then read window.__units of
// a page still on its title card (a proof run died on its first camera).
...
const CAMS = {
  ...
  rpvlow: { u: 0, t: [4.5, 6, 0], d: 26, e: -0.22 },
  // the nozzles: where a pipe meets a vessel wall, close enough to see the bore
  hotnoz: { u: 0, t: [1.4, 13, 0], d: 7, e: 0.1 },
  coldnoz: { u: 0, t: [1.4, 8.2, 0], d: 7, e: 0.1 },
  headnoz: { u: 0, t: [-6.5, 12.5, 0], d: 9, e: 0.1 },
  feednoz: { u: 0, t: [-5.5, 24, 0], d: 9, e: 0.1 },
  // the containment penetrations: the steam and feed lines out, the vent
  wallsteam: { u: 0, t: [15.9, 14, 0], d: 9, e: 0.1 },
  wallfeed: { u: 0, t: [15.9, 1.64, 0], d: 8, e: 0.1 },
  wallvent: { u: 0, t: [-15.9, 26, 0], d: 8, e: 0.1 },
  cpump: { u: 0, t: [17.6, 0.6, 0], d: 9, e: 0.1 },
  cwpump: { u: 0, t: [30.6, -0.8, 0], d: 11, e: 0.1 },
  sg:     { u: 0, t: [-8.5, 20, 0], d: 40 },
  head:   { u: 0, t: [-8.5, 13, 0], d: 20 },
  headB:  { u: 1, t: [-8.5, 13, 0], d: 20 },
  ...
  tank:   { u: 0, t: [-6.5, 3.5, 0], d: 34 },
  steam:  { u: 0, t: [8, 24, 0], d: 44 },
  turbine:{ u: 0, t: [23.5, 6.8, 0], d: 31 },
  cond:   { u: 0, t: [23.5, 3.2, 0], d: 24, e: 0.16 },
  sump:   { u: 0, t: [23.5, 1.8, 0], d: 13, e: 0.42 },
  pool2:  { u: 0, t: [23.5, 1.8, 0], d: 12, e: 0.85 },
  bay:    { u: 0, t: [31, 0, -10], d: 30, e: 0.3 },
  power:  { u: 0, t: [26.6, 11, 0], d: 18 },
...
await page.waitForFunction(() => window.__units && window.__units.length > 0 && window.__stage, null, { timeout: 60000 });
