...
import { clamp, lerp, TAU, rnd } from './util.js';
...
function buildSprites() {
  sprite('light', [[0, 'rgba(255,255,255,1)'], [0.55, 'rgba(238,246,252,0.72)'], [1, 'rgba(226,238,248,0)']]);
  sprite('dark', [[0, 'rgba(96,94,98,1)'], [0.55, 'rgba(52,50,54,0.72)'], [1, 'rgba(36,34,38,0)']]);
  sprite('fire', [[0, 'rgba(255,250,214,1)'], [0.32, 'rgba(255,178,60,0.92)'], [0.68, 'rgba(226,88,26,0.5)'], [1, 'rgba(140,34,10,0)']]);
  sprite('plume', [[0, 'rgba(196,240,152,1)'], [0.5, 'rgba(140,198,110,0.6)'], [1, 'rgba(110,150,90,0)']]);
