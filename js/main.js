...
import { Sim } from './sim.js?v=d7d0f53269';
import { Renderer } from './site/renderer.js?v=d7d0f53269';
import { unproject } from './site/iso.js?v=d7d0f53269';
import { Stage } from './view/stage.js?v=d7d0f53269';
import { Unit, CUT_AZ } from './view/unit.js?v=d7d0f53269';
import { Labels } from './view/labels.js?v=d7d0f53269';
import { UI } from './ui.js?v=d7d0f53269';
import { initPhysics } from './machines.js?v=d7d0f53269';
import { state } from './view/state.js?v=d7d0f53269';
import { loadNetwork } from './view/hydro.js?v=d7d0f53269';
import { loadPlant } from './view/model.js?v=d7d0f53269';
import { AutoQ } from './view/autoq.js?v=d7d0f53269';
import { clamp } from './util.js?v=d7d0f53269';
...
async function boot() {
  ...
  if (GL_OK) {
    ...
    // The fluid library's solver runs under each unit with every flow held
    // (day one of the migration); without its network the app is as before.
    try { await loadNetwork(); } catch (e) { console.warn('station network not loaded; the fluid solver stays off', e); }
...
function frame(now) {
  ...
  if (sim.view === 'plant' && stage) {
    for (const u of units) if (u.root.visible) u.update(state(u.plant), dt, sim.speed * dt);
